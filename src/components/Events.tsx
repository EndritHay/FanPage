    ...
    <section id="events" className="py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-10">
          <div>
            ...
            <div className="space-y-4">
              {pastEvents.map((event, index) => (
                <Card
                  key={index}
                  className="p-6 bg-gradient-to-br from-card/40 to-card/20 backdrop-blur-sm border-primary/20 hover:border-primary/40 transition-all duration-300 hover:scale-105"
                >
                  <div className="flex justify-between items-start mb-3">
                    <h4 className="font-semibold text-lg text-foreground">{event.title}</h4>
                    <span className="text-xs text-foreground/60 bg-primary/10 px-3 py-1 rounded-full">{event.date}</span>
                  </div>
          ...
          {/* Event submission */}
          <div className="bg-gradient-to-br from-primary/20 to-red-900/20 backdrop-blur-xl rounded-2xl p-8 border border-primary/30 hover:shadow-2xl hover:shadow-primary/20 transition-all duration-500">
